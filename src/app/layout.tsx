...
export const metadata: Metadata = {
  title: "Pilates em Casa | Guia Definitivo para Postura, Dores e Fortalecimento",
  ...
  openGraph: {
    title: "Pilates em Casa | Guia Definitivo para Postura e Fortalecimento",
  ...
  twitter: {
    ...
    title: "Pilates em Casa | Guia Definitivo",
    description: "Aprenda exercícios de Pilates de forma simples e ilustrada para aliviar dores nas costas e melhorar sua postura.",
    images: ["/clinicflow-cover.png"],
  },
};
